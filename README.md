## ros_numpy (noetic) - 0.0.4-5

The packages in the `ros_numpy` repository were released into the `noetic` distro by running `/usr/bin/bloom-release ros_numpy --track noetic --rosdistro noetic --new-track` on `Sun, 25 Oct 2020 17:59:18 -0000`
...
## ros_numpy (noetic) - 0.0.4-4

The packages in the `ros_numpy` repository were released into the `noetic` distro by running `/usr/bin/bloom-release ros_numpy --track noetic --rosdistro noetic --new-track` on `Fri, 02 Oct 2020 09:59:42 -0000`
...
## ros_numpy (noetic) - 0.0.4-3

The packages in the `ros_numpy` repository were released into the `noetic` distro by running `/usr/bin/bloom-release ros_numpy --track noetic --rosdistro noetic --new-track` on `Fri, 02 Oct 2020 09:50:38 -0000`
...
## ros_numpy (noetic) - 0.0.4-2

The packages in the `ros_numpy` repository were released into the `noetic` distro by running `/usr/bin/bloom-release ros_numpy --track noetic --rosdistro noetic --new-track` on `Fri, 02 Oct 2020 09:46:07 -0000`
